...
<!-- 제이쿼리 -->
<script
	src="${pageContext.request.contextPath}/resources/js/jquery/jquery-2.2.2.min.js"></script>
<!-- 부트스트랩 -->
<script
...
<c:choose>
	<c:when test="${browser == 'MSIE'}">
		...
		<script
			src='https://cdnjs.cloudflare.com/ajax/libs/core-js/2.5.5/core.min.js'></script>
	</c:when>
</c:choose>
<!-- 스윗얼럿(알림) -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/js/sweetalert2/sweetalert2.css">
<script
	src="${pageContext.request.contextPath}/resources/js/sweetalert2/sweetalert2.js"></script>
<!-- 드롭존(파일업로드) -->
<script
	src="${pageContext.request.contextPath}/resources/js/dropzone/dropzone.js"></script>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/js/dropzone/basic.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/js/dropzone/dropzone.css">
<!-- 다운로드 js-->
<script
	src="${pageContext.request.contextPath}/resources/js/download/download.js"></script>
<!-- proj4js -->
<script
	src="${pageContext.request.contextPath}/resources/js/proj4js/dist/proj4-src.js"></script>
<%-- 오픈 레이어스3 --%>
<script
	src="${pageContext.request.contextPath}/resources/js/ol3/ol-debug.js"></script>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/js/ol3/ol.css">
<%-- jsTree--%>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/jsTree/jstree.js"></script>
...
<%-- jsTree openlayers3--%>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/jsTree-openlayers3/jstree.js"></script>
<link rel="stylesheet" type="text/css"
...
<!-- shp2geojson -->
<script
	src="${pageContext.request.contextPath}/resources/js/shp2geojson/preview.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/shp2geojson/preprocess.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/shp2geojson/jszip.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/shp2geojson/jszip-utils.js"></script>
<!-- gb CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/js/gb/css/gb.css">
<!-- gb namespace -->
<script
...
<!-- gb.tree.geoserver -->
<script
	src="${pageContext.request.contextPath}/resources/js/gb/tree/geoserver.js"></script>
<!-- gb.tree.openlayers -->
<script
	src="${pageContext.request.contextPath}/resources/js/gb/tree/openlayers.js"></script>
<!-- gb.versioning.repository  -->
<script
	src="${pageContext.request.contextPath}/resources/js/gb/versioning/repository.js"></script>
<!-- gb.edit -->
<script
	src="${pageContext.request.contextPath}/resources/js/gb/edit/edithistory.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/gb/edit/undo.js"></script>
<!-- gb.footer -->
<script
	src="${pageContext.request.contextPath}/resources/js/gb/footer/base.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/gb/footer/featureList.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/gb/footer/command.js"></script>
<!-- gb.header -->
<script
	src="${pageContext.request.contextPath}/resources/js/gb/header/base.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/gb/header/editingtool.js"></script>
<!-- gb.interaction -->
<script
...
<script
	src="${pageContext.request.contextPath}/resources/js/gb/interaction/copy-paste.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/gb/interaction/measuretip.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/gb/interaction/holedraw.js"></script>
<!-- gb.geocoder -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/js/gb/css/ol-geocoder.css">
<script
	src="${pageContext.request.contextPath}/resources/js/gb/geocoder/ol-geocoder.js"></script>
<!-- gb.map.MousePosition -->
<script
	src="${pageContext.request.contextPath}/resources/js/gb/map/mouseposition.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/gb/geocoder/ol-geocoder.js"></script>
