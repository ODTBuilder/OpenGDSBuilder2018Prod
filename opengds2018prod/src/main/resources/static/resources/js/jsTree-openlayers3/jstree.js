			...
			$.jstreeol3.core.prototype = {
				...
				bind : function() {
					...
					this.element.on("dblclick.jstreeol3", function(e) {
						...
						switch (e.which) {
						case 32: // aria defines space only
							// with Ctrl
							if (e.ctrlKey) {
								e.type = "click";
						...
						case 40: // down
							...
							break;
						case 106: // aria defines * on numpad
							// as open_all -
							// not very common
							this.open_all();
							break;
						...
						case 35: // end
							...
							break;
						case 113: // f2 - safe to include - if
							// check_callback
				...
				zoom_to_fit : function(obj) {
					...
					if (layer instanceof ol.layer.Group) {
						...
						this._data.core.map.getView().fit(extent, this._data.core.map.getSize());
						return;
					}
					...
					if (source instanceof ol.source.TileWMS) {
						...
						var view = this._data.core.map.getView();
						view.fit(source.getExtent(), this._data.core.map.getSize());
					}
				},
				/**
