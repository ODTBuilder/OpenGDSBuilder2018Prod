...
public interface DTGeoserverServiceFactory {
	 ...
	 * @param version     Geoserver 버전
	 * @param format      {@link EnWMSOutputFormat} PNG, PNG8, JPEG, GIF, TIFF,
	 *                    TIFF8, GeoTIFF, GeoTIFF8, SVG, PDF, GEORSS, KML, KMZ
	 * @param layers      레이어명
	 ...
	 * @param serverURL 서버 URL
	 * @param version   Geoserver 버전
	 * @param format    {@link EnWMSOutputFormat} PNG, PNG8, JPEG, GIF, TIFF, TIFF8,
	 *                  GeoTIFF, GeoTIFF8, SVG, PDF, GEORSS, KML, KMZ
	 * @param layers    레이어명
	 * @param tiled     Tile 서비스 적용여부
	 * @param crs       좌표계 Geoserver 버전이 1.0.0 or 1.1.0 or 1.1.1 일 경우
	 * @param srs       좌표계 Geoserver 버전이 1.3.0
