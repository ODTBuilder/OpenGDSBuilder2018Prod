...
/**
 * @classdesc
 * 피처에 대해 Scale, Rotate, Flip 편집을 수행할 수 있는 Interaction.
 * ol.Map에 추가하여 기능을 사용한다.
 * @class gb.interaction.MultiTransform
 * @memberof gb.interaction
 * @constructor
 * @param {Object} opt_options - gb.interaction.MultiTransform 생성 옵션
 * @param {ol.Collection.<ol.Feature>} opt_options.features - MultiTransform을 적용시킬 feature 객체 집합
 * @author KIM HOCHUL
 * @date 2019. 03. 25
 * @version 0.01
 */
...
/**
 * 커서 이동 이벤트 처리 함수.drag 실행 중에는 실행되지 않는다.
 * {this.selectTask_} 함수를 통해 MultiTransform 버튼의 위치를 인식하고
 ...
 * @param {Array.<number>} cursor - 맵 위에서의 마우스 커서 좌표
 ...
 * @function
 * @param {Array.<number>} prevCursorPosition - 'pointerdrag'이벤트 발생 전의 커서 위치값
 * @param {Array.<number>} currentCursorPosition - 'pointerdrag'이벤트 발생 시의 커서 위치값
